...
(function() {
  ...
  //  document.getElementById("run").addEventListener("click", function(person) {   -> if you want to display in text box after clicking the button
        people.forEach(function (person) {
            if (person.firstname == "Jean" && person.lastname == "Dupont") {
                console.log(people.indexOf(person));
                console.log(person.email);
         //       alert(person.email);    email of the person displayed in text box
            }
        });
 //   })
